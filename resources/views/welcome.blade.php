        ...
        <form action="" class="mt-20">
            <div class="w-full relative max-w-[860px] mx-auto px-5 pb-[138px] pt-24">
                <div class="w-full mx-auto flex flex-col items-center justify-center">
                    <h1 class="text-center w-full mx-auto heading-primary mb-3">
                        The best Courses and Books on the
                        <span class="text-orange">Laravel</span> ecosystem
                    </h1>
                    <p class="text-secoundery-color w-full text-lg text-center my-4 mb-10">
                        Find the right books and courses on the Laravel framework and
                        related topics to suite your level of expertise. Know how good
                        a course is through your peers review and share your own too.
                    </p>
                    ...
                    <div class="flex w-[700px] gap-x-6">
                        <input type="search" name="keyword" placeholder="Enter keywords to search courses"
                            ...
                            required />
                        <button type="submit" class="btn-primary w-1/5 text-white">
                            Search
                        </button>
                    </div>
                </div>
                <!--hero icon-->
                <img src="{{asset('img/left-top-angle.png')}}" alt="angle"
                    class="absolute pointer-events-none top-[150px] -left-28" />
                <img src="{{asset('img/left-bottom-angle.png')}}" alt="angle"
                    class="absolute pointer-events-none top-[370px] -left-12" />
                <img src="{{asset('img/right-angle.png')}}" alt="angle"
                    class="absolute pointer-events-none top-[70px] -right-6" />
                <img src="{{asset('img/right-bottom-angle.png')}}" alt="angle"
                    class="absolute pointer-events-none top-[360px] -right-24" />
            </div>
        </form>
        <img src="{{asset('img/right-center-angle.png')}}" alt="angle"
    ...
    <div class="container">
        <ul class="flex items-center flex-nowrap justify-between gap-y-7 gap-3">
            ...
            <li class="w-full lg:max-w-[165px]">
                <a href="#"
                    class="bg-white border mx-auto border-orange box-shadow w-full rounded-lg flex items-center justify-center">
                    <img src="{{$value->image}}" alt="{{$value->name}}"
                        class="w-20 md:w-auto h-15 p-3 object-contain img_size" />
                </a>
            </li>
            @endforeach
        ...
        <div class="container">
            ...
            <div class="flex justify-center mt-12 mb-12">
                <a href="https://laravel-courses.com/courses">
                    <button class="btn-primary text-white h-14 w-32">
                        Browse all
                    </button>
                </a>
            </div>
